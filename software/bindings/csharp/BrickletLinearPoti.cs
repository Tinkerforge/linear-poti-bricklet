...
{
	public class BrickletLinearPoti : Device 
	{
		...
		public delegate void Position(ushort position);
		public delegate void AnalogValue(ushort value);
		public delegate void PositionReached(ushort position);
		public delegate void AnalogValueReached(ushort value);

		public BrickletLinearPoti(string uid) : base(uid) 
		{
		...
		public void GetPosition(out ushort position)
		{
			...
			position = LEConverter.UShortFrom(4, answer);
		...
		{
			ushort position = LEConverter.UShortFrom(4, data);
